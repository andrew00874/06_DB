...
SELECT current_time() as 현재시간, date_add(current_date(), interval -1 day) as 어제, date_add(current_date(), interval 1 day) as 내일;
...
FROM STUDENT
WHERE SUBSTR(ENTRANCE_DATE, 1, 4) = 2005;
...
FROM PROFESSOR
WHERE DEPARTMENT_NO IS NOT NULL;.FFCCC
