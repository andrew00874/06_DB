...
대표적으로
SELECT VERSION(); Ctrl + Enter (한 줄 실행) 으로 버전이 무사히 잘 나오면 잘 동작하는 중
...
-- CREATE DATABASE IF NOT EXISTS 0000000; 0000000 의 이름을 가진 DB 생성
-- 한줄 작성 완료 후 뒤에 반드시 ; 붙여야함

CREATE DATABASE IF NOT EXISTS employee_management;

-- USER : 개발자나 관리자가 사용할 데이터베이스 명칭을 선택해서 사용
-- 이후 실행될 모든 SQL 명령어는 0000000 데이터베이스에서 동작하고 사용하도록 설정
