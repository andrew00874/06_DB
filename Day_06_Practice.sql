...
VALUES('맘스터치 대학로점', 13, '대전시 유성구 대학로 100', '042-123-4567', '수제버거 전문점', 12000, '2500', 4.6, '매일 10:30 - 22:00'); 
-- 문제 4
...
VALUES('이수진', 'suejin@naver.com', 'sue9876', '서울시 영등포구 당산로 200'), ('김태원', 'taewon88@gmail.com', 'tae4567', '부산시 부산진구 서면로 150'), ('박소희', 'sohee@daum.net', 'hope123', '인천시 연수구 송도대로 300');
-- 문제 5
...
VALUES (1, '치킨마요덮밥', 8500), (1, '새우튀김', 15000), (1, '김치찌개', 7000);
-- 문제 6
...
UPDATE MENUS
SET PRICE = 23000, DESCRIPTION = '리뉴얼된 뿌링클! 더욱 바삭해진 식감'
WHERE MENU_ID = 1;
-- 문제 11
...
WHERE RATING <= 4.5;
-- 문제 15
-- Korean 카테고리에 속한 모든 매장의 운영시간을 '매일 24시간'으로 변경하시오. 4번
UPDATE STORES
...
SELECT * FROM ORDERS;
UPDATE ORDERS
SET ORDER_STATUS = CONCAT('VIP_', ORDER_STATUS)
WHERE TOTAL_PRICE >= 30000 AND ORDER_STATUS = 'Delivered';
-- 문제 26
